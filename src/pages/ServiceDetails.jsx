        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 space-y-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <img
              src={service.image}
              alt={service.title}
              className="rounded-2xl h-[400px] w-full shadow-2xl border-4 border-blue-200 hover:scale-105 transition-transform duration-500"
            />
            <div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-blue-50 p-8 rounded-3xl shadow-xl border border-blue-100 hover:shadow-blue-300 transition transform hover:-translate-y-1">
              <h3 className="text-3xl font-semibold text-blue-700 mb-6 flex items-center gap-3">
                <FaLeaf /> Key Features
              </h3>
            ...
            <div className="bg-blue-50 p-8 rounded-3xl shadow-xl border border-blue-100 hover:shadow-blue-300 transition transform hover:-translate-y-1">
              ...
              <ul className="space-y-4 text-gray-800 text-lg">
                {service.benefits.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <FaHandsHelping className="text-blue-500 mt-1" />
                    {item}
                  </li>
                ))}
              </ul>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {service.treatmentSteps.map((step, i) => (
                <div
                  key={i}
                  className="p-8 bg-blue-50 rounded-3xl shadow-xl border border-blue-200 hover:shadow-blue-400 transition transform hover:-translate-y-2"
                >
          ...
          <div className="bg-gradient-to-r from-blue-50 via-white to-blue-50 p-6 rounded-3xl shadow-2xl">
            <h3 className="text-4xl font-bold text-blue-800 mb-10 text-center flex items-center justify-center gap-3">
            ...
            <div className="grid md:grid-cols-2 gap-12 text-gray-700">
              <div className="space-y-6">
                ...
                <p className="text-xl">
                  <FaShieldAlt className="inline text-blue-500 mr-2" />
                  <span className="font-semibold text-blue-700">Validity:</span>{" "}
                  {service.extraInfo.validity}
                </p>
                <p className="text-xl">
                  <FaLeaf className="inline text-blue-500 mr-2" />
                  <span className="font-semibold text-blue-700">Suitable For:</span>{" "}
                  {service.extraInfo.suitableFor}
                </p>
              </div>
              <div>
                <p className="text-2xl font-semibold text-blue-700 mb-3">Conditions:</p>
                ...
                <p className="mt-6 text-xl">
                  <FaRegSmile className="inline text-blue-500 mr-2" />
                  <span className="font-semibold text-blue-700">After Care:</span>{" "}
