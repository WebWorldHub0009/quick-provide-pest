  ...
  return (
    <section className="relative bg-gradient-to-br from-[#F9F9F9] to-[#EAF6EF] px-6 md:px-12 lg:px-20 py-8 font-raleway overflow-hidden">
        ...
        >
          <defs>
            <linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style={{ stopColor: "#3CB463", stopOpacity: 6 }} />
              <stop offset="100%" style={{ stopColor: "#004C8C", stopOpacity: 0.6 }} />
            </linearGradient>
          </defs>
      ...
      <div className="mb-6 text-center lg:text-left relative z-10">
        ...
        <div className="w-20 h-1 bg-green-600 mt-2 rounded-full mx-auto lg:mx-0"></div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start relative z-10">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <p className="absolute -top-8 text-xl text-green-700 bg-white shadow-md px-5 py-2 rounded-full">
          ...
          {/* Badge */}
          <div className="absolute -bottom-10 bg-white border-4 border-green-600 rounded-full w-40 h-40 flex flex-col items-center justify-center shadow-xl hover:scale-105 transition-transform duration-500">
            <FaLeaf className="text-green-600 text-3xl mb-2" />
            <p className="font-semibold text-green-700 text-sm text-center">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-center relative z-10">
        <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-2xl hover:-translate-y-2 transition-all">
          <FaShieldAlt className="text-green-600 text-3xl mx-auto mb-3" />
          <h4 className="text-xl font-bold text-gray-900">Safe Solutions</h4>
        ...
        <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-2xl hover:-translate-y-2 transition-all">
          ...
          <h4 className="text-xl font-bold text-gray-900">Eco-Friendly</h4>
          <p className="mt-2 text-gray-600">
        ...
        <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-2xl hover:-translate-y-2 transition-all">
          <FaShieldAlt className="text-green-600 text-3xl mx-auto mb-3" />
          <h4 className="text-xl font-bold text-gray-900">Trusted Experts</h4>
          <p className="mt-2 text-gray-600">
