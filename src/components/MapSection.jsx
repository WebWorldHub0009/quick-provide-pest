...
const MapSection = () => {
  return (
    <section className="relative w-full bg-[#f9f9f9] py-10 font-[Raleway]">
      {/* Section Title */}
      ...
      {/* Map Container */}
      <div className="w-full max-w-7xl mx-auto relative overflow-hidden rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.25)] border-4 border-[#3CB371]/80">
        <iframe
        ...
        {/* Info Card Overlay */}
        <div className="absolute bottom-6 right-6 bg-black/80 text-white p-6 rounded-2xl max-w-sm shadow-2xl backdrop-blur-md">
          ...
          <a
            ...
            className="mt-4 inline-block bg-gradient-to-r from-[#3CB371] to-[#2E8B57] text-black px-5 py-2 rounded-full font-semibold hover:scale-105 hover:shadow-lg transition-all"
          >
            📍 View on Google Maps
          </a>
        </div>
