  ...
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-r from-[#004C8C] via-[#2ECC71] to-[#004C8C] text-white font-sans">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between py-1 px-4 text-xs md:text-sm gap-1 sm:gap-0">
          {/* Left side - Udyam */}
          <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-start">
            <p className="flex items-center gap-1">
              <FaIdBadge className="text-red-500" />
              <a href="#" className="hover:underline">UDYAM: DL-08-0095527</a>
            </p>
            <p className="flex items-center gap-1">
              <MdEmail className="text-red-500" />
              <span>GSTIN: 07BDUPK7506B1ZH</span>
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-end">
            <p className="flex items-center gap-1">
              <FaPhoneAlt /> 
              <a href="tel:+919958717631" className="hover:underline">+91 99587 17131</a>
            </p>
            <p className="flex items-center gap-1">
              <FaPhoneAlt /> 
